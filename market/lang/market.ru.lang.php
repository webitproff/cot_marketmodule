...
$L['cfg_default_type'] = array('Тип по-умолчанию');
...
$L['info_desc'] = 'Products Marketplace - Раздел размещения товаров индивидуальными продавцами';
...
$L['market_title'] = 'Маркетплейс';
$L['market_descr'] = 'Каталог товаров и продукции, от профессиональных продавцов и исполнителей';
$L['market_myproducts'] = 'Мои товары';

$L['market_catalog'] = 'Каталог категорий';
...
$L['market_notfound'] = 'Разработки и цифровые товары не найдены';
$L['market_empty'] = 'Разработок и цифровых товаров нет';
...
$L['plu_market_set_sec'] = 'Категории маркетплейса';
...
$L['market_types_edit'] = 'Правка типов';
$L['market_types_new'] = 'Создать категорию';
$L['market_types_editor'] = 'Редактор типов';