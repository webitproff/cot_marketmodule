...
$t->assign(array(
	...
	"PRDEDIT_FORM_TYPETITLE" => (is_array($market_types) && !empty($item['item_type'])) ? $market_types[$item['item_type']] : '',
	"PRDEDIT_FORM_TYPE" => (is_array($market_types)) ? cot_selectbox(($item['item_type']) ? $item['item_type'] : $cfg['market']['default_type'], 'rtype', array_keys($market_types), array_values($market_types)) : 'empty',
	"PRDEDIT_FORM_TITLE" => cot_inputbox('text', 'rtitle', $item['item_title'], 'size="56"'),
	'PRDEDIT_FORM_KEYWORDS' => cot_inputbox('text', 'rkeywords', $item['item_keywords'], array('size' => '32', 'maxlength' => '255')),
